								...
								<Grid item xs={12} md={6}>
									<Tooltip title="Enter the unique client identification code" arrow placement="top-start">
										<Autocomplete
											...
											renderInput={(params) => <StyledTextField {...params} fullWidth size="small" label="Client Code" placeholder="e.g., CL-12345" required error={!!errors.clientCode} helperText={errors.clientCode || "Client's unique identifier"} />}
										/>
									</Tooltip>
								</Grid>
								<Grid item xs={12} md={6}>
								...
								<Grid item xs={12} md={6}>
									<Tooltip title="Who are you communicating with?" arrow placement="top-start">
										<StyledTextField
											...
											value={formData?.communicationWith}
											onChange={handleInputChange("communicationWith")}
									...
									<Grid item xs={12} md={6}>
										<Tooltip title="Select the type of service required" arrow placement="top-start">
											<StyledFormControl fullWidth required size="small" error={!!errors.serviceType}>
												...
												<Select value={formData.serviceType} onChange={handleInputChange("serviceType")} label="Service Type" autoSelect blurOnSelect>
							...
							<Grid container spacing={2}>
								<Grid item xs={12} md={4}>
									<Tooltip title="Enter the ticket reference number" arrow placement="top-start">
										<StyledTextField fullWidth size="small" label="Ticket Number" value={formData.ticketNo} onChange={handleInputChange("ticketNo")} placeholder="TKT-0000" error={!!errors.ticketNo} helperText={errors.ticketNo || "Internal ticket reference"} />
									</Tooltip>
								</Grid>
								<Grid item xs={12} md={4}>
								...
								<Grid item xs={12} md={4}>
									<Tooltip title="Date when the client requested this service" arrow placement="top-start">
										<StyledTextField fullWidth size="small" label="Request Date" type="date" value={formData.requestDate} onChange={handleInputChange("requestDate")} InputLabelProps={{ shrink: true }} required error={!!errors.requestDate} helperText={errors.requestDate || "When client made the request"} />
									</Tooltip>
								</Grid>
								<Grid item xs={12} md={6}>
									<Tooltip title="Date when the request was confirmed" arrow placement="top-start">
										<StyledTextField
											...
											onChange={handleInputChange("confirmationDate")}
											InputLabelProps={{ shrink: true }}
											error={!!errors.confirmationDate}
											helperText={errors.confirmationDate || "When the request was confirmed"}
											required
										/>
									</Tooltip>
								</Grid>
								...
								<Grid item xs={12} md={6}>
									<Tooltip title="Specify the type of topic for better categorization" arrow placement="top-start">
										<StyledFormControl error={!!errors.topicType} fullWidth required size="small">
											...
											<FormHelperText>{errors.topicType || "Specific request type"}</FormHelperText>
										</StyledFormControl>
									</Tooltip>
								</Grid>
								<Grid item xs={12} md={6}>
									...
									<Grid item xs={12} md={4}>
										<Tooltip title="Select the department for this assignment" arrow placement="top-start">
											<Autocomplete
												...
												renderInput={(params) => <StyledTextField {...params} label="Department" fullWidth required size="small" error={!!formErrors?.department} helperText={formErrors?.department || "Select responsible department"} />}
											/>
										</Tooltip>
									</Grid>
									...
									<Grid item xs={12} md={4}>
										<Tooltip title="Choose the team member to assign" arrow placement="top-start">
											<Autocomplete
												...
												onChange={(e, val) => handleChange("user", val)}
												renderInput={(params) => <StyledTextField {...params} label="Assigned To" fullWidth required size="small" error={!!formErrors.user} helperText={formErrors.user || "Select team member"} />}
											/>
										</Tooltip>
									</Grid>
