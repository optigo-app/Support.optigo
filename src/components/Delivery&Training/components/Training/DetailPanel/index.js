			...
			<Box>
				...
				<Box mb={4} p={2}>
					...
					<Box mb={3}>
						...
						<Box display="flex" alignItems="center" gap={1} bgcolor="#e6f0ff" p={2} borderRadius={1}>
							<AccessTimeIcon color="primary" fontSize="small" />
							<Typography fontWeight="medium">
								{open?.StartTime && format(parse(open?.StartTime || "", "HH:mm", new Date()), "hh:mm a")} -{open?.EndTime && format(parse(open?.EndTime || "", "HH:mm", new Date()), "hh:mm a")}
							</Typography>
						</Box>
					</Box>
					<Box mb={3}>
