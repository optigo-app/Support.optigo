					...
					InputProps={{
						startAdornment: (
							<>
								...
								/>
								<MenuList options={DATE_FIELDS} anchorEl={anchorElStatus} open={Boolean(anchorElStatus)} handleClose={() => setAnchorElStatus(null)} handleSelect={handleStatusSelect} selectedValue={tempRange?.status || "All"} />
							</>
						),
