...
const HeaderWrapper = ({ children, handleOpen }) => {
	...
	const allowedPaths = ["/test", "/Training", "/Delivery", "/delivery", "/training", "Training/Client", "/Training/client", "/Training/", "/training/", "Training/Client/", "/Training/client/", "/Delivery/", "/delivery/", "/delivery/", "/delivery", "/Delivery", "/Delivery/"];
