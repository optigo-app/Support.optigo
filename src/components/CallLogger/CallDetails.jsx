							...
							<Grid item xs={12} sm={6}>
								<Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
									...
									<Chip
										...
										label={new Date(defaultCallLogData?.date)?.toLocaleDateString("en-GB")}
										color="default"
										size="medium"
										sx={{
											fontSize: "0.8rem",
							...
							{defaultCallLogData?.appname && (
								<Grid item xs={12} sm={6}>
									<Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
										...
										<Chip
											label={defaultCallLogData?.appname}
											color="info"
											size="medium"
											sx={{
												fontSize: "0.8rem",
										...
										<EllipsisCell
											value={
												<Chip
													...
													color={DetailgetStatusColor(defaultCallLogData?.status)}
													size="medium"
													sx={{
														fontSize: "0.8rem",
														height: 20,
									...
									{defaultCallLogData?.feedback && (
										<Grid item xs={12} sm={6}>
											<Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
												...
												<Chip
													label={defaultCallLogData?.feedback}
													color="success"
													size="medium"
													sx={{
														fontSize: "0.8rem",
									...
									{defaultCallLogData?.priority && (
										<Grid item xs={12} sm={6}>
											<Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
												...
												<Chip
													label={defaultCallLogData?.priority}
													color={DetailgetPriorityColor(defaultCallLogData?.priority)}
													size="medium"
													sx={{
														fontSize: "0.8rem",
														height: 20,
								...
								<Grid container spacing={1}>
									...
									<Grid item xs={12} sm={6}>
										<Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
											...
											<Chip
												label={defaultCallLogData?.parentId}
												color="default"
												size="medium"
												sx={{
													fontSize: "0.8rem",
							...
							<Grid container spacing={1}>
								<Grid item xs={12} sm={6}>
									<Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
										...
										<Chip
											icon={<Ticket size={18} />}
											label={defaultCallLogData?.ticket}
											color="default"
											size="medium"
											sx={{
												fontSize: "0.8rem",
