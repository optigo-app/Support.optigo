			...
			<Grid container spacing={3}>
				<Grid item xs={12} sm={6}>
					<Autocomplete
						...
						blurOnSelect
						handleHomeEndKeys
						renderInput={(params) => <TextField {...params} label="Company Code" required error={Boolean(errors.projectCode)} helperText={errors.projectCode ? "Company Code is required" : ""} />}
					/>
				</Grid>
				...
				<Grid item xs={12} sm={6}>
					<Autocomplete
						...
						autoSelect
						blurOnSelect
						renderInput={(params) => <TextField {...params} label="User Name" required error={Boolean(errors.userName)} helperText={errors.userName ? "User Name is required" : ""} />}
					/>
				</Grid>
				...
				<Grid item xs={12} sm={6}>
					<Autocomplete
						...
						autoSelect
						blurOnSelect
						renderInput={(params) => <TextField {...params} label="Category" required error={Boolean(errors.category)} helperText={errors.category ? "Category is required" : ""} />}
					/>
				</Grid>
				...
				<Grid item xs={12} sm={6}>
					<Autocomplete
						...
						autoSelect
						blurOnSelect
						renderInput={(params) => <TextField {...params} label="Appname" required error={Boolean(errors.appname)} helperText={errors.appname ? "Appname is required" : ""} />}
					/>
				</Grid>
				...
				<Grid item xs={12}>
					<TextField label="Special Instruction" fullWidth multiline rows={4} variant="outlined" value={form.instruction} error={Boolean(errors.instruction)} helperText={errors.instruction ? "Special Instruction is required" : ""} onChange={(e) => handleChange("instruction", e.target.value)} />
				</Grid>
					...
					>
						...
						>
							<Tooltip
								...
								title={previewURL ? <img src={previewURL} alt="Preview" width={200} height={200} style={{ borderRadius: "5px" }} /> : <small>Please Select Image</small>}
								arrow
								placement="top"
							>
