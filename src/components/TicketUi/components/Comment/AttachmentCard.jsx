...
const AttachmentCard = ({ comment, openAttachmentId, handleToggleCollapse }) => {
  ...
  return <Box sx={{ mb: 1.5 }}>{isMultiple ? <MultipleAttachmentCard attachments={attachments} comment={comment} openAttachmentId={openAttachmentId} handleToggleCollapse={handleToggleCollapse} /> : <SingleAttachmentCard attachment={attachments[0]} comment={comment} openAttachmentId={openAttachmentId} handleToggleCollapse={handleToggleCollapse} />}</Box>;
};

const SingleAttachmentCard = ({ attachment, comment, openAttachmentId, handleToggleCollapse }) => {
...
const MultipleAttachmentCard = ({ attachments, comment, openAttachmentId, handleToggleCollapse }) => {
      ...
      >
        ...
        <Stack direction="row" spacing={0.5} alignItems="center">
          <Tooltip title="Open current file">
            <IconButton size="small" onClick={(e) => handleOpenFile(attachments[selectedIndex], e)}>
              <OpenInNewIcon fontSize="small" />
            </IconButton>
          </Tooltip>
          <IconButton size="small">{isExpanded ? <ExpandLessIcon /> : <ExpandMoreIcon />}</IconButton>
